...
Usage：filename <command...> [<file_names>...]

<Commands>
-h: View the help document.
-s: Delete safemd5 file.
-m: Delete malive file.
-c: Cloud scan.
<file_names>
--file=[file_path]: File save the path
--log=[log_path]: Log save the path

Note: if you don't take commands parameters,this program is only HASH value of the scanning,will not be any inquires the results to be saved the local database.
...
class MD5_Search(object):
    ...
    def __init__(self):
        ...
        self.url = "http://cloud.sucop.com/index.php?m=Com&a=hashQuery"
